...
6. The C# scripts of the buttons are in the Assets folder. For each button add the corresponding script to the Inspector of that button. Set OnClick() for a button as follows:
